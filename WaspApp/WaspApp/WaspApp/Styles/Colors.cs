...
namespace WaspApp.Styles
{
    public static class Colors
    {
        // Common
        public static readonly Color PrimaryColor = Color.FromHex("#82BC43");
        public static readonly Color PrimaryDarkColor = Color.FromHex("#006847");
        ...
        public static readonly Color CommonGrayColor = Color.FromHex("#212B36");
        ...
        public static readonly Color NavBarColor = Color.FromHex("#121212");
        ...
        public static readonly Color TextLightPrimary = new Color(CommonBlackColor.R, CommonBlackColor.G, CommonBlackColor.B, 1);
        public static readonly Color TextLightSecondary = new Color(CommonBlackColor.R, CommonBlackColor.G, CommonBlackColor.B, 0.87);
        public static readonly Color TextLightHint = new Color(CommonBlackColor.R, CommonBlackColor.G, CommonBlackColor.B, 0.6);
        public static readonly Color TextLightDisabled = new Color(CommonBlackColor.R, CommonBlackColor.G, CommonBlackColor.B, 0.38);
