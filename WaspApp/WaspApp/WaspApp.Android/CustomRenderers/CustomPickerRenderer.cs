...
namespace WaspApp.Droid.CustomRenderers
{
    public class CustomPickerRenderer : PickerRenderer
    {
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == CustomPicker.DisabledTextColorProperty.PropertyName)
                UpdateDisabledTextColor(picker);

            Draw(picker);
        }

        void Draw(CustomPicker picker)
        {
            if (picker.BorderType == CustomPickerBorderType.Frame)
                DrawFrame(picker);
            else if (picker.BorderType == CustomPickerBorderType.Line)
                DrawLine(picker);
            else
                DrawNone();
        }

        void DrawFrame(CustomPicker picker)
        {
        ...
        private void DrawLine(CustomPicker picker)
        {
            // Background drawable
        ...
        private void UpdateDisabledTextColor(CustomPicker picker)
        {
